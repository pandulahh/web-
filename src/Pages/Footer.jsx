				...
				<div class="md:flex md:justify-between">
					<div class="mb-6 md:mb-0">
						<a href="#" class="flex items-center">
							<img
								src="https://static.schoolmedia.id/assets/socmed/NI/photo/profil-smpn3llg.png"
								alt=""
					...
					<div class="grid grid-cols-2 sm:grid-cols-3">
						<div className=" ">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/pandulahh/?hl=id" class="hover:underline">
										Pandu ketchee
									</a>
								</li>
								<li>
									<a href="https://www.instagram.com/badaileonardo_/?hl=id" class="hover:underline">
										Badai proplayer
									</a>
								</li>
							</ul>
						...
						<div className="">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/ospensmartllg/?hl=id" class="hover:underline ">
										Instagram
									</a>
								</li>
								<li>
				...
				<div class="sm:flex sm:items-center sm:justify-between">
					<div class="flex mt-4 justify-center sm:mt-0">
						<p className="text-[0.7rem] text-white opacity-70">
							© {new Date().getFullYear()} OSIS SPENGA 2023/2024
						</p>
					</div>
				</div>
			</div>
